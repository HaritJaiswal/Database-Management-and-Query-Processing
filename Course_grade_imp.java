...
interface GradeInfo_ {
   ...
   public static int gradepoint(LetterGrade all_grades)
   {switch(all_grades)
		{case A:
			return 10;
		case Aminus:
	...
	public static void main(String[] args) {Coursegrade c1 = new Coursegrade();
		...
		while(it.hasNext())
			{Coursegrade cgd=it.next();
				grade_info gi = (grade_info)cgd.grade();
				int points = gi.GetPointsOfGrade();
				System.out.println(cgd);
				System.out.println(cgd.coursenum()+ "  "+cgd.student_grade+"  "+points);
			}
